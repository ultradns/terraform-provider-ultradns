		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_sb", "control_ip", "192.168.1.1"),
					resource.TestCheckResourceAttr("data.ultradns_probe_tcp.data_tcp_sb", "connect_limit.0.fail", "fail"),
				),
			},
			{
